...
module Computer_System_mm_interconnect_3 (
	...
	wire          rsp_mux_src_valid;                                                                 // rsp_mux:src_valid -> VGA_Subsystem_pixel_dma_master_agent:rp_valid
	wire   [74:0] rsp_mux_src_data;                                                                  // rsp_mux:src_data -> VGA_Subsystem_pixel_dma_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                 // VGA_Subsystem_pixel_dma_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                               // rsp_mux:src_channel -> VGA_Subsystem_pixel_dma_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                         // rsp_mux:src_startofpacket -> VGA_Subsystem_pixel_dma_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                           // rsp_mux:src_endofpacket -> VGA_Subsystem_pixel_dma_master_agent:rp_endofpacket
	...
	wire          vga_subsystem_pixel_dma_master_agent_cp_valid;                                     // VGA_Subsystem_pixel_dma_master_agent:cp_valid -> router:sink_valid
	wire   [74:0] vga_subsystem_pixel_dma_master_agent_cp_data;                                      // VGA_Subsystem_pixel_dma_master_agent:cp_data -> router:sink_data
	wire          vga_subsystem_pixel_dma_master_agent_cp_ready;                                     // router:sink_ready -> VGA_Subsystem_pixel_dma_master_agent:cp_ready
	wire          vga_subsystem_pixel_dma_master_agent_cp_startofpacket;                             // VGA_Subsystem_pixel_dma_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          vga_subsystem_pixel_dma_master_agent_cp_endofpacket;                               // VGA_Subsystem_pixel_dma_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	Computer_System_mm_interconnect_3_router_001 router_001 (
	...
	Computer_System_mm_interconnect_3_cmd_demux rsp_demux (
		.clk                (System_PLL_sys_clk_clk),                             //       clk.clk
		.reset              (Onchip_SRAM_reset1_reset_bridge_in_reset_reset),     // clk_reset.reset
