...
int main(void)
{
	...
	while(1) 
	{
		...
		VGA_box(64, 0, 240, 50, 0x03); // blue box
		VGA_box(250, 0, 425, 50, 0xe0); // red box
		VGA_box(435, 0, 600, 50, 0x1c); // green box
		...
		VGA_circle(320, 200, circle_x, color_counter);
		VGA_circle(320, 200, circle_x+1, color_counter++);
		circle_x += 4 ;
		if (circle_x > 130) circle_x = 0;
		
		//void VGA_rect(int x1, int y1, int x2, int y2, short pixel_color)
		VGA_rect(10, 478, box_x, 478-box_x, rand()&0xff);
		box_x += 5 ;
		...
		VGA_Vline(Vline_x, 475, 475-(Vline_x>>2), rand()&0xff);
		Vline_x += 2 ;
		if (Vline_x > 620) Vline_x = 350;
		
		//void VGA_Hline(int x1, int y1, int x2, short pixel_color)
		VGA_Hline(400, Hline_y, 550, rand()&0xff);
		Hline_y += 2 ;
