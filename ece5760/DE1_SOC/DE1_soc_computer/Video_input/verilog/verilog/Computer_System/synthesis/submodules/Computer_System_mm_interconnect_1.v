...
module Computer_System_mm_interconnect_1 (
	...
	wire  [101:0] rsp_mux_002_src_data;                                                                                // rsp_mux_002:src_data -> Video_In_Subsystem_video_in_dma_master_agent:rp_data
	...
	wire  [101:0] video_in_subsystem_video_in_dma_master_agent_cp_data;                                                // Video_In_Subsystem_video_in_dma_master_agent:cp_data -> router_002:sink_data
	...
	wire  [101:0] vga_subsystem_char_buffer_slave_agent_rp_data;                                                       // VGA_Subsystem_char_buffer_slave_agent:rp_data -> router_004:sink_data
	...
	wire          cmd_demux_002_src0_valid;                                                                            // cmd_demux_002:src0_valid -> Video_In_Subsystem_video_in_dma_master_to_SDRAM_s1_cmd_width_adapter:in_valid
	wire  [101:0] cmd_demux_002_src0_data;                                                                             // cmd_demux_002:src0_data -> Video_In_Subsystem_video_in_dma_master_to_SDRAM_s1_cmd_width_adapter:in_data
	wire          cmd_demux_002_src0_ready;                                                                            // Video_In_Subsystem_video_in_dma_master_to_SDRAM_s1_cmd_width_adapter:in_ready -> cmd_demux_002:src0_ready
	wire    [3:0] cmd_demux_002_src0_channel;                                                                          // cmd_demux_002:src0_channel -> Video_In_Subsystem_video_in_dma_master_to_SDRAM_s1_cmd_width_adapter:in_channel
	wire          cmd_demux_002_src0_startofpacket;                                                                    // cmd_demux_002:src0_startofpacket -> Video_In_Subsystem_video_in_dma_master_to_SDRAM_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_002_src0_endofpacket;                                                                      // cmd_demux_002:src0_endofpacket -> Video_In_Subsystem_video_in_dma_master_to_SDRAM_s1_cmd_width_adapter:in_endofpacket
	wire          video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_valid;                      // Video_In_Subsystem_video_in_dma_master_to_SDRAM_s1_cmd_width_adapter:out_valid -> cmd_mux_001:sink2_valid
	wire  [110:0] video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_data;                       // Video_In_Subsystem_video_in_dma_master_to_SDRAM_s1_cmd_width_adapter:out_data -> cmd_mux_001:sink2_data
	wire          video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_ready;                      // cmd_mux_001:sink2_ready -> Video_In_Subsystem_video_in_dma_master_to_SDRAM_s1_cmd_width_adapter:out_ready
	wire    [3:0] video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_channel;                    // Video_In_Subsystem_video_in_dma_master_to_SDRAM_s1_cmd_width_adapter:out_channel -> cmd_mux_001:sink2_channel
	wire          video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_startofpacket;              // Video_In_Subsystem_video_in_dma_master_to_SDRAM_s1_cmd_width_adapter:out_startofpacket -> cmd_mux_001:sink2_startofpacket
	wire          video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_endofpacket;                // Video_In_Subsystem_video_in_dma_master_to_SDRAM_s1_cmd_width_adapter:out_endofpacket -> cmd_mux_001:sink2_endofpacket
	...
	wire  [101:0] cmd_demux_002_src1_data;                                                                             // cmd_demux_002:src1_data -> Video_In_Subsystem_video_in_dma_master_to_Onchip_SRAM_s1_cmd_width_adapter:in_data
	...
	wire          rsp_demux_001_src2_valid;                                                                            // rsp_demux_001:src2_valid -> SDRAM_s1_to_Video_In_Subsystem_video_in_dma_master_rsp_width_adapter:in_valid
	wire  [110:0] rsp_demux_001_src2_data;                                                                             // rsp_demux_001:src2_data -> SDRAM_s1_to_Video_In_Subsystem_video_in_dma_master_rsp_width_adapter:in_data
	wire          rsp_demux_001_src2_ready;                                                                            // SDRAM_s1_to_Video_In_Subsystem_video_in_dma_master_rsp_width_adapter:in_ready -> rsp_demux_001:src2_ready
	wire    [3:0] rsp_demux_001_src2_channel;                                                                          // rsp_demux_001:src2_channel -> SDRAM_s1_to_Video_In_Subsystem_video_in_dma_master_rsp_width_adapter:in_channel
	wire          rsp_demux_001_src2_startofpacket;                                                                    // rsp_demux_001:src2_startofpacket -> SDRAM_s1_to_Video_In_Subsystem_video_in_dma_master_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_001_src2_endofpacket;                                                                      // rsp_demux_001:src2_endofpacket -> SDRAM_s1_to_Video_In_Subsystem_video_in_dma_master_rsp_width_adapter:in_endofpacket
	wire          sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_valid;                      // SDRAM_s1_to_Video_In_Subsystem_video_in_dma_master_rsp_width_adapter:out_valid -> rsp_mux_002:sink0_valid
	wire  [101:0] sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_data;                       // SDRAM_s1_to_Video_In_Subsystem_video_in_dma_master_rsp_width_adapter:out_data -> rsp_mux_002:sink0_data
	wire          sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_ready;                      // rsp_mux_002:sink0_ready -> SDRAM_s1_to_Video_In_Subsystem_video_in_dma_master_rsp_width_adapter:out_ready
	wire    [3:0] sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_channel;                    // SDRAM_s1_to_Video_In_Subsystem_video_in_dma_master_rsp_width_adapter:out_channel -> rsp_mux_002:sink0_channel
	wire          sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_startofpacket;              // SDRAM_s1_to_Video_In_Subsystem_video_in_dma_master_rsp_width_adapter:out_startofpacket -> rsp_mux_002:sink0_startofpacket
	wire          sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_endofpacket;                // SDRAM_s1_to_Video_In_Subsystem_video_in_dma_master_rsp_width_adapter:out_endofpacket -> rsp_mux_002:sink0_endofpacket
	...
	wire  [101:0] onchip_sram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_data;                 // Onchip_SRAM_s1_to_Video_In_Subsystem_video_in_dma_master_rsp_width_adapter:out_data -> rsp_mux_002:sink1_data
	...
	Computer_System_mm_interconnect_1_cmd_mux_001 cmd_mux_001 (
		...
		.sink2_ready         (video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_ready),         //     sink2.ready
		.sink2_valid         (video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_valid),         //          .valid
		.sink2_channel       (video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink2_data          (video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_data),          //          .data
		.sink2_startofpacket (video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink2_endofpacket   (video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
	...
	Computer_System_mm_interconnect_1_cmd_demux_002 rsp_demux (
		.clk                (System_PLL_sys_clk_clk),                  //       clk.clk
		.reset              (SDRAM_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Computer_System_mm_interconnect_1_rsp_mux_002 rsp_mux_002 (
		...
		.sink0_ready         (sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_ready),               //     sink0.ready
		.sink0_valid         (sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_valid),               //          .valid
		.sink0_channel       (sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_channel),             //          .channel
		.sink0_data          (sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_data),                //          .data
		.sink0_startofpacket (sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_startofpacket),       //          .startofpacket
		.sink0_endofpacket   (sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_endofpacket),         //          .endofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter (
		.clk                  (System_PLL_sys_clk_clk),                                                                 //       clk.clk
		.reset                (SDRAM_reset_reset_bridge_in_reset_reset),                                                // clk_reset.reset
		...
		.out_endofpacket      (video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (video_in_subsystem_video_in_dma_master_to_sdram_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                                  // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter (
		.clk                  (System_PLL_sys_clk_clk),                                                                 //       clk.clk
		.reset                (SDRAM_reset_reset_bridge_in_reset_reset),                                                // clk_reset.reset
		...
		.out_endofpacket      (sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_data),          //          .data
		.out_channel          (sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (sdram_s1_to_video_in_subsystem_video_in_dma_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                                  // (terminated)
	);
