...
// compile with:
//   gcc Logic_analyzer_7.c -o la7  -O3
//////////////////////////////////////////////
...
int main(void)
{
	...
	while(1) 
	{
		...
		printf("\n\r enter trigger mask, trigger value, h_zoom(1,2,3,4)\n\r");
		...
		char fmt[]="%03d %02x " ; 
		char title[]="Phase" ;
		print_HOLA(-5, 5, 0, 0xff, 'u', fmt, title) ;
		
		char fmt_s[]="%03d %d " ; 
		char title_s[]="sine" ;
		print_HOLA(-5, 5, 8, 0xffff, 's', fmt_s, title_s) ;
