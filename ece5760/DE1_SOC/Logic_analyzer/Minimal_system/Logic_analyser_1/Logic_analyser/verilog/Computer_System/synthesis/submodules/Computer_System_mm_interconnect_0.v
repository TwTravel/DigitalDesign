...
module Computer_System_mm_interconnect_0 (
		...
		input  wire         analyser_buffer_reset2_reset_bridge_in_reset_reset,                    //                    analyser_buffer_reset2_reset_bridge_in_reset.reset
		...
		output wire [9:0]   analyser_buffer_s2_address,                                            //                                              analyser_buffer_s2.address
		output wire         analyser_buffer_s2_write,                                              //                                                                .write
		input  wire [31:0]  analyser_buffer_s2_readdata,                                           //                                                                .readdata
		output wire [31:0]  analyser_buffer_s2_writedata,                                          //                                                                .writedata
		output wire [3:0]   analyser_buffer_s2_byteenable,                                         //                                                                .byteenable
		output wire         analyser_buffer_s2_chipselect,                                         //                                                                .chipselect
		output wire         analyser_buffer_s2_clken,                                              //                                                                .clken
	...
	wire   [31:0] analyser_buffer_s2_agent_m0_readdata;                       // analyser_buffer_s2_translator:uav_readdata -> analyser_buffer_s2_agent:m0_readdata
	wire          analyser_buffer_s2_agent_m0_waitrequest;                    // analyser_buffer_s2_translator:uav_waitrequest -> analyser_buffer_s2_agent:m0_waitrequest
	wire          analyser_buffer_s2_agent_m0_debugaccess;                    // analyser_buffer_s2_agent:m0_debugaccess -> analyser_buffer_s2_translator:uav_debugaccess
	wire   [29:0] analyser_buffer_s2_agent_m0_address;                        // analyser_buffer_s2_agent:m0_address -> analyser_buffer_s2_translator:uav_address
	wire    [3:0] analyser_buffer_s2_agent_m0_byteenable;                     // analyser_buffer_s2_agent:m0_byteenable -> analyser_buffer_s2_translator:uav_byteenable
	wire          analyser_buffer_s2_agent_m0_read;                           // analyser_buffer_s2_agent:m0_read -> analyser_buffer_s2_translator:uav_read
	wire          analyser_buffer_s2_agent_m0_readdatavalid;                  // analyser_buffer_s2_translator:uav_readdatavalid -> analyser_buffer_s2_agent:m0_readdatavalid
	wire          analyser_buffer_s2_agent_m0_lock;                           // analyser_buffer_s2_agent:m0_lock -> analyser_buffer_s2_translator:uav_lock
	wire   [31:0] analyser_buffer_s2_agent_m0_writedata;                      // analyser_buffer_s2_agent:m0_writedata -> analyser_buffer_s2_translator:uav_writedata
	wire          analyser_buffer_s2_agent_m0_write;                          // analyser_buffer_s2_agent:m0_write -> analyser_buffer_s2_translator:uav_write
	wire    [2:0] analyser_buffer_s2_agent_m0_burstcount;                     // analyser_buffer_s2_agent:m0_burstcount -> analyser_buffer_s2_translator:uav_burstcount
	wire          analyser_buffer_s2_agent_rf_source_valid;                   // analyser_buffer_s2_agent:rf_source_valid -> analyser_buffer_s2_agent_rsp_fifo:in_valid
	wire  [125:0] analyser_buffer_s2_agent_rf_source_data;                    // analyser_buffer_s2_agent:rf_source_data -> analyser_buffer_s2_agent_rsp_fifo:in_data
	wire          analyser_buffer_s2_agent_rf_source_ready;                   // analyser_buffer_s2_agent_rsp_fifo:in_ready -> analyser_buffer_s2_agent:rf_source_ready
	wire          analyser_buffer_s2_agent_rf_source_startofpacket;           // analyser_buffer_s2_agent:rf_source_startofpacket -> analyser_buffer_s2_agent_rsp_fifo:in_startofpacket
	wire          analyser_buffer_s2_agent_rf_source_endofpacket;             // analyser_buffer_s2_agent:rf_source_endofpacket -> analyser_buffer_s2_agent_rsp_fifo:in_endofpacket
	wire          analyser_buffer_s2_agent_rsp_fifo_out_valid;                // analyser_buffer_s2_agent_rsp_fifo:out_valid -> analyser_buffer_s2_agent:rf_sink_valid
	wire  [125:0] analyser_buffer_s2_agent_rsp_fifo_out_data;                 // analyser_buffer_s2_agent_rsp_fifo:out_data -> analyser_buffer_s2_agent:rf_sink_data
	wire          analyser_buffer_s2_agent_rsp_fifo_out_ready;                // analyser_buffer_s2_agent:rf_sink_ready -> analyser_buffer_s2_agent_rsp_fifo:out_ready
	wire          analyser_buffer_s2_agent_rsp_fifo_out_startofpacket;        // analyser_buffer_s2_agent_rsp_fifo:out_startofpacket -> analyser_buffer_s2_agent:rf_sink_startofpacket
	wire          analyser_buffer_s2_agent_rsp_fifo_out_endofpacket;          // analyser_buffer_s2_agent_rsp_fifo:out_endofpacket -> analyser_buffer_s2_agent:rf_sink_endofpacket
	wire          analyser_buffer_s2_agent_rdata_fifo_src_valid;              // analyser_buffer_s2_agent:rdata_fifo_src_valid -> analyser_buffer_s2_agent_rdata_fifo:in_valid
	wire   [33:0] analyser_buffer_s2_agent_rdata_fifo_src_data;               // analyser_buffer_s2_agent:rdata_fifo_src_data -> analyser_buffer_s2_agent_rdata_fifo:in_data
	wire          analyser_buffer_s2_agent_rdata_fifo_src_ready;              // analyser_buffer_s2_agent_rdata_fifo:in_ready -> analyser_buffer_s2_agent:rdata_fifo_src_ready
	...
	wire          analyser_buffer_s2_agent_rp_valid;                          // analyser_buffer_s2_agent:rp_valid -> router_002:sink_valid
	wire  [124:0] analyser_buffer_s2_agent_rp_data;                           // analyser_buffer_s2_agent:rp_data -> router_002:sink_data
	wire          analyser_buffer_s2_agent_rp_ready;                          // router_002:sink_ready -> analyser_buffer_s2_agent:rp_ready
	wire          analyser_buffer_s2_agent_rp_startofpacket;                  // analyser_buffer_s2_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          analyser_buffer_s2_agent_rp_endofpacket;                    // analyser_buffer_s2_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          analyser_buffer_s2_burst_adapter_source0_valid;             // analyser_buffer_s2_burst_adapter:source0_valid -> analyser_buffer_s2_agent:cp_valid
	wire  [124:0] analyser_buffer_s2_burst_adapter_source0_data;              // analyser_buffer_s2_burst_adapter:source0_data -> analyser_buffer_s2_agent:cp_data
	wire          analyser_buffer_s2_burst_adapter_source0_ready;             // analyser_buffer_s2_agent:cp_ready -> analyser_buffer_s2_burst_adapter:source0_ready
	wire    [1:0] analyser_buffer_s2_burst_adapter_source0_channel;           // analyser_buffer_s2_burst_adapter:source0_channel -> analyser_buffer_s2_agent:cp_channel
	wire          analyser_buffer_s2_burst_adapter_source0_startofpacket;     // analyser_buffer_s2_burst_adapter:source0_startofpacket -> analyser_buffer_s2_agent:cp_startofpacket
	wire          analyser_buffer_s2_burst_adapter_source0_endofpacket;       // analyser_buffer_s2_burst_adapter:source0_endofpacket -> analyser_buffer_s2_agent:cp_endofpacket
	...
	wire          router_002_src_valid;                                       // router_002:src_valid -> analyser_buffer_s2_rsp_width_adapter:in_valid
	wire  [124:0] router_002_src_data;                                        // router_002:src_data -> analyser_buffer_s2_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                       // analyser_buffer_s2_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                                     // router_002:src_channel -> analyser_buffer_s2_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                               // router_002:src_startofpacket -> analyser_buffer_s2_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                 // router_002:src_endofpacket -> analyser_buffer_s2_rsp_width_adapter:in_endofpacket
	wire          analyser_buffer_s2_rsp_width_adapter_src_valid;             // analyser_buffer_s2_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [232:0] analyser_buffer_s2_rsp_width_adapter_src_data;              // analyser_buffer_s2_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          analyser_buffer_s2_rsp_width_adapter_src_ready;             // rsp_demux:sink_ready -> analyser_buffer_s2_rsp_width_adapter:out_ready
	wire    [1:0] analyser_buffer_s2_rsp_width_adapter_src_channel;           // analyser_buffer_s2_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          analyser_buffer_s2_rsp_width_adapter_src_startofpacket;     // analyser_buffer_s2_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          analyser_buffer_s2_rsp_width_adapter_src_endofpacket;       // analyser_buffer_s2_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                          // cmd_mux:src_valid -> analyser_buffer_s2_cmd_width_adapter:in_valid
	wire  [232:0] cmd_mux_src_data;                                           // cmd_mux:src_data -> analyser_buffer_s2_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                          // analyser_buffer_s2_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                        // cmd_mux:src_channel -> analyser_buffer_s2_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                  // cmd_mux:src_startofpacket -> analyser_buffer_s2_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                    // cmd_mux:src_endofpacket -> analyser_buffer_s2_cmd_width_adapter:in_endofpacket
	wire          analyser_buffer_s2_cmd_width_adapter_src_valid;             // analyser_buffer_s2_cmd_width_adapter:out_valid -> analyser_buffer_s2_burst_adapter:sink0_valid
	wire  [124:0] analyser_buffer_s2_cmd_width_adapter_src_data;              // analyser_buffer_s2_cmd_width_adapter:out_data -> analyser_buffer_s2_burst_adapter:sink0_data
	wire          analyser_buffer_s2_cmd_width_adapter_src_ready;             // analyser_buffer_s2_burst_adapter:sink0_ready -> analyser_buffer_s2_cmd_width_adapter:out_ready
	wire    [1:0] analyser_buffer_s2_cmd_width_adapter_src_channel;           // analyser_buffer_s2_cmd_width_adapter:out_channel -> analyser_buffer_s2_burst_adapter:sink0_channel
	wire          analyser_buffer_s2_cmd_width_adapter_src_startofpacket;     // analyser_buffer_s2_cmd_width_adapter:out_startofpacket -> analyser_buffer_s2_burst_adapter:sink0_startofpacket
	wire          analyser_buffer_s2_cmd_width_adapter_src_endofpacket;       // analyser_buffer_s2_cmd_width_adapter:out_endofpacket -> analyser_buffer_s2_burst_adapter:sink0_endofpacket
	...
	wire          analyser_buffer_s2_agent_rdata_fifo_out_valid;              // analyser_buffer_s2_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] analyser_buffer_s2_agent_rdata_fifo_out_data;               // analyser_buffer_s2_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          analyser_buffer_s2_agent_rdata_fifo_out_ready;              // avalon_st_adapter:in_0_ready -> analyser_buffer_s2_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                              // avalon_st_adapter:out_0_valid -> analyser_buffer_s2_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                               // avalon_st_adapter:out_0_data -> analyser_buffer_s2_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                              // analyser_buffer_s2_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                              // avalon_st_adapter:out_0_error -> analyser_buffer_s2_agent:rdata_fifo_sink_error
	...
	) analyser_buffer_s2_translator (
		.clk                    (System_PLL_sys_clk_clk),                             //                      clk.clk
		.reset                  (analyser_buffer_reset2_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (analyser_buffer_s2_agent_m0_address),                // avalon_universal_slave_0.address
		.uav_burstcount         (analyser_buffer_s2_agent_m0_burstcount),             //                         .burstcount
		.uav_read               (analyser_buffer_s2_agent_m0_read),                   //                         .read
		.uav_write              (analyser_buffer_s2_agent_m0_write),                  //                         .write
		.uav_waitrequest        (analyser_buffer_s2_agent_m0_waitrequest),            //                         .waitrequest
		.uav_readdatavalid      (analyser_buffer_s2_agent_m0_readdatavalid),          //                         .readdatavalid
		.uav_byteenable         (analyser_buffer_s2_agent_m0_byteenable),             //                         .byteenable
		.uav_readdata           (analyser_buffer_s2_agent_m0_readdata),               //                         .readdata
		.uav_writedata          (analyser_buffer_s2_agent_m0_writedata),              //                         .writedata
		.uav_lock               (analyser_buffer_s2_agent_m0_lock),                   //                         .lock
		.uav_debugaccess        (analyser_buffer_s2_agent_m0_debugaccess),            //                         .debugaccess
		.av_address             (analyser_buffer_s2_address),                         //      avalon_anti_slave_0.address
		.av_write               (analyser_buffer_s2_write),                           //                         .write
		.av_readdata            (analyser_buffer_s2_readdata),                        //                         .readdata
		.av_writedata           (analyser_buffer_s2_writedata),                       //                         .writedata
		.av_byteenable          (analyser_buffer_s2_byteenable),                      //                         .byteenable
		.av_chipselect          (analyser_buffer_s2_chipselect),                      //                         .chipselect
		.av_clken               (analyser_buffer_s2_clken),                           //                         .clken
		.av_read                (),                                                   //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) analyser_buffer_s2_agent (
		.clk                     (System_PLL_sys_clk_clk),                                 //             clk.clk
		.reset                   (analyser_buffer_reset2_reset_bridge_in_reset_reset),     //       clk_reset.reset
		.m0_address              (analyser_buffer_s2_agent_m0_address),                    //              m0.address
		.m0_burstcount           (analyser_buffer_s2_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (analyser_buffer_s2_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (analyser_buffer_s2_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (analyser_buffer_s2_agent_m0_lock),                       //                .lock
		.m0_readdata             (analyser_buffer_s2_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (analyser_buffer_s2_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (analyser_buffer_s2_agent_m0_read),                       //                .read
		.m0_waitrequest          (analyser_buffer_s2_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (analyser_buffer_s2_agent_m0_writedata),                  //                .writedata
		.m0_write                (analyser_buffer_s2_agent_m0_write),                      //                .write
		.rp_endofpacket          (analyser_buffer_s2_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (analyser_buffer_s2_agent_rp_ready),                      //                .ready
		.rp_valid                (analyser_buffer_s2_agent_rp_valid),                      //                .valid
		.rp_data                 (analyser_buffer_s2_agent_rp_data),                       //                .data
		.rp_startofpacket        (analyser_buffer_s2_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (analyser_buffer_s2_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (analyser_buffer_s2_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (analyser_buffer_s2_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (analyser_buffer_s2_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (analyser_buffer_s2_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (analyser_buffer_s2_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (analyser_buffer_s2_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (analyser_buffer_s2_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (analyser_buffer_s2_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (analyser_buffer_s2_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (analyser_buffer_s2_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (analyser_buffer_s2_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (analyser_buffer_s2_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (analyser_buffer_s2_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (analyser_buffer_s2_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (analyser_buffer_s2_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                          // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                          //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                           //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                          //                .error
		.rdata_fifo_src_ready    (analyser_buffer_s2_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (analyser_buffer_s2_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (analyser_buffer_s2_agent_rdata_fifo_src_data),           //                .data
	...
	) analyser_buffer_s2_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                              //       clk.clk
		.reset             (analyser_buffer_reset2_reset_bridge_in_reset_reset),  // clk_reset.reset
		.in_data           (analyser_buffer_s2_agent_rf_source_data),             //        in.data
		.in_valid          (analyser_buffer_s2_agent_rf_source_valid),            //          .valid
		.in_ready          (analyser_buffer_s2_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (analyser_buffer_s2_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (analyser_buffer_s2_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (analyser_buffer_s2_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (analyser_buffer_s2_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (analyser_buffer_s2_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (analyser_buffer_s2_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (analyser_buffer_s2_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) analyser_buffer_s2_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                             //       clk.clk
		.reset             (analyser_buffer_reset2_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (analyser_buffer_s2_agent_rdata_fifo_src_data),       //        in.data
		.in_valid          (analyser_buffer_s2_agent_rdata_fifo_src_valid),      //          .valid
		.in_ready          (analyser_buffer_s2_agent_rdata_fifo_src_ready),      //          .ready
		.out_data          (analyser_buffer_s2_agent_rdata_fifo_out_data),       //       out.data
		.out_valid         (analyser_buffer_s2_agent_rdata_fifo_out_valid),      //          .valid
		.out_ready         (analyser_buffer_s2_agent_rdata_fifo_out_ready),      //          .ready
		.csr_address       (2'b00),                                              // (terminated)
		.csr_read          (1'b0),                                               // (terminated)
		.csr_write         (1'b0),                                               // (terminated)
		.csr_readdata      (),                                                   // (terminated)
	...
	Computer_System_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (analyser_buffer_s2_agent_rp_ready),                  //      sink.ready
		.sink_valid         (analyser_buffer_s2_agent_rp_valid),                  //          .valid
		.sink_data          (analyser_buffer_s2_agent_rp_data),                   //          .data
		.sink_startofpacket (analyser_buffer_s2_agent_rp_startofpacket),          //          .startofpacket
		.sink_endofpacket   (analyser_buffer_s2_agent_rp_endofpacket),            //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                             //       clk.clk
		.reset              (analyser_buffer_reset2_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	) analyser_buffer_s2_burst_adapter (
		.clk                   (System_PLL_sys_clk_clk),                                 //       cr0.clk
		.reset                 (analyser_buffer_reset2_reset_bridge_in_reset_reset),     // cr0_reset.reset
		.sink0_valid           (analyser_buffer_s2_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (analyser_buffer_s2_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (analyser_buffer_s2_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (analyser_buffer_s2_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (analyser_buffer_s2_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (analyser_buffer_s2_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (analyser_buffer_s2_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (analyser_buffer_s2_burst_adapter_source0_data),          //          .data
		.source0_channel       (analyser_buffer_s2_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (analyser_buffer_s2_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (analyser_buffer_s2_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (analyser_buffer_s2_burst_adapter_source0_ready)          //          .ready
	);
	...
	Computer_System_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (System_PLL_sys_clk_clk),                                 //       clk.clk
		.reset              (analyser_buffer_reset2_reset_bridge_in_reset_reset),     // clk_reset.reset
		.sink_ready         (analyser_buffer_s2_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (analyser_buffer_s2_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (analyser_buffer_s2_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (analyser_buffer_s2_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (analyser_buffer_s2_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (analyser_buffer_s2_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
	...
	) analyser_buffer_s2_rsp_width_adapter (
		.clk                  (System_PLL_sys_clk_clk),                                 //       clk.clk
		.reset                (analyser_buffer_reset2_reset_bridge_in_reset_reset),     // clk_reset.reset
		...
		.out_endofpacket      (analyser_buffer_s2_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (analyser_buffer_s2_rsp_width_adapter_src_data),          //          .data
		.out_channel          (analyser_buffer_s2_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (analyser_buffer_s2_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (analyser_buffer_s2_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (analyser_buffer_s2_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) analyser_buffer_s2_cmd_width_adapter (
		.clk                  (System_PLL_sys_clk_clk),                                 //       clk.clk
		.reset                (analyser_buffer_reset2_reset_bridge_in_reset_reset),     // clk_reset.reset
		...
		.out_endofpacket      (analyser_buffer_s2_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (analyser_buffer_s2_cmd_width_adapter_src_data),          //          .data
		.out_channel          (analyser_buffer_s2_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (analyser_buffer_s2_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (analyser_buffer_s2_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (analyser_buffer_s2_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                  // (terminated)
	);
	...
	Computer_System_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (analyser_buffer_reset2_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (analyser_buffer_s2_agent_rdata_fifo_out_data),       //     in_0.data
		.in_0_valid     (analyser_buffer_s2_agent_rdata_fifo_out_valid),      //         .valid
		.in_0_ready     (analyser_buffer_s2_agent_rdata_fifo_out_ready),      //         .ready
