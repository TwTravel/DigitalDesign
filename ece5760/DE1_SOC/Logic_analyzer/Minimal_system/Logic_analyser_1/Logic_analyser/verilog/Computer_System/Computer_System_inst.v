	Computer_System u0 (
		.control_sram_address            (<connected-to-control_sram_address>),            //         control_sram.address
		.control_sram_clken              (<connected-to-control_sram_clken>),              //                     .clken
		.control_sram_chipselect         (<connected-to-control_sram_chipselect>),         //                     .chipselect
		.control_sram_write              (<connected-to-control_sram_write>),              //                     .write
		.control_sram_readdata           (<connected-to-control_sram_readdata>),           //                     .readdata
		.control_sram_writedata          (<connected-to-control_sram_writedata>),          //                     .writedata
		.control_sram_byteenable         (<connected-to-control_sram_byteenable>),         //                     .byteenable
		...
		.logic_analyser_sram_address     (<connected-to-logic_analyser_sram_address>),     //  logic_analyser_sram.address
		.logic_analyser_sram_clken       (<connected-to-logic_analyser_sram_clken>),       //                     .clken
		.logic_analyser_sram_chipselect  (<connected-to-logic_analyser_sram_chipselect>),  //                     .chipselect
		.logic_analyser_sram_write       (<connected-to-logic_analyser_sram_write>),       //                     .write
		.logic_analyser_sram_readdata    (<connected-to-logic_analyser_sram_readdata>),    //                     .readdata
		.logic_analyser_sram_writedata   (<connected-to-logic_analyser_sram_writedata>),   //                     .writedata
		.logic_analyser_sram_byteenable  (<connected-to-logic_analyser_sram_byteenable>),  //                     .byteenable
