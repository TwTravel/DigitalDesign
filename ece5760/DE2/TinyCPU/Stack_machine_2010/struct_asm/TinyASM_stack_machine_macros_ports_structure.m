...
opcode{1,1} = 'pushi';  opcode{1,2} ='1000';
opcode{2,1} = 'push';   opcode{2,2} ='2000';
opcode{3,1} = 'pop';    opcode{3,2} ='3000';
opcode{4,1} = 'jmp';    opcode{4,2} ='4000';
opcode{5,1} = 'jz';     opcode{5,2} ='5000';
opcode{6,1} = 'jnz';    opcode{6,2} ='6000';
opcode{7,1} = 'ld';     opcode{7,2} ='7000';
opcode{8,1} = 'st';     opcode{8,2} ='8000';
opcode{9,1} = 'pushpc'; opcode{9,2} ='9000';
opcode{10,1} = 'poppc'; opcode{10,2}='a000';
opcode{11,1} = 'in';    opcode{11,2}='d000';
opcode{12,1} = 'out';   opcode{12,2}='e000';
opcode{13,1} = 'add';   opcode{13,2}='f000';
opcode{14,1} = 'sub';   opcode{14,2}='f001';
opcode{15,1} = 'mul';   opcode{15,2}='f002';
opcode{16,1} = 'shl';   opcode{16,2}='f003';
opcode{17,1} = 'shr';   opcode{17,2}='f004';
opcode{18,1} = 'band';  opcode{18,2}='f005';
opcode{19,1} = 'bor';   opcode{19,2}='f006';
opcode{20,1} = 'bxor';  opcode{20,2}='f007';
opcode{21,1} = 'and';   opcode{21,2}='f008';
opcode{22,1} = 'or';    opcode{22,2}='f009';
opcode{23,1} = 'eq';    opcode{23,2}='f00a';
opcode{24,1} = 'ne';    opcode{24,2}='f00b';
opcode{25,1} = 'ge';    opcode{25,2}='f00c';
opcode{26,1} = 'le';    opcode{26,2}='f00d';
opcode{27,1} = 'gt';    opcode{27,2}='f00e';
opcode{28,1} = 'lt';    opcode{28,2}='f00f';
opcode{29,1} = 'neg';   opcode{29,2}='f010';
opcode{30,1} = 'bnot';  opcode{30,2}='f011';
opcode{31,1} = 'not';  opcode{31,2}='f012';
opcode{32,1} = 'nop';  opcode{32,2}='0000';
...
for i=1:nCodeLine
    ...
    if (~isempty(CodeLine{i,2}))
        % check for numeric
        if (~isempty(str2num(CodeLine{i,2})))
    ...
    if isnan(inst_arg) & ...
            ((opcode_index>0 & opcode_index<7) | opcode_index==11 | opcode_index==12)
        error(['Need argument in code line:', num2str(i)])
    end
    
    % onloy pushi can have a negative argument
    if (inst_arg<0 & opcode_index>1)
        error(['Argument must be positive in code line:', num2str(i)])
    end
    
    if ~isnan(inst_arg) & ( opcode_index>=7 & opcode_index~=11 & opcode_index~=12)
